...
const certificates = [
  ...
  },
  {
    ...
    description:
      "Official Udyam Registration Certificate under MSME, recognizing Kerla Packers as a verified and trusted enterprise.",
    file: udyam,
    tag: "MSME Verified",
  },
];
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16" id="docs">
            ...
            <p
              ...
              style={{ color: COLORS.charcoal }}
            >
              At <span className="font-bold">{`Kerla Packers`}</span>, transparency is our foundation. Explore our{" "}

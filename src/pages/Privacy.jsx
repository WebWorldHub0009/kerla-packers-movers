    ...
    <section className="min-h-screen bg-cream text-charcoal py-12 px-6 sm:px-12 lg:px-24">
      <div className="max-w-5xl mx-auto">
        ...
        <p className="mb-4" style={{ color: COLORS.charcoal }}>
          At <strong>Kerla Packers</strong>, your privacy is very important to us. This Privacy Policy explains how we collect, use, and protect your personal information when you use our services or visit our website.
        </p>
        ...
        <p className="mb-2" style={{ color: COLORS.charcoal }}>
          <strong>Address:</strong> Kerla Packers & Movers, [Plot No. 2971/3, Gali No. 3, Near Banke Bihari Temple,

...
const servicesData = [
  {
    ...
    overview: "Kerla Packers provides comprehensive relocation services across Kerla. We manage packing, loading, transport, and unloading with precision. Our team ensures that fragile and valuable items are handled carefully, delivering a seamless and stress-free moving experience. Every move is planned meticulously, prioritizing safety, punctuality, and customer satisfaction to ensure your belongings arrive intact and on time, making relocation efficient and worry-free.",
  ...
  },
  {
    ...
    overview: "Kerla Packers offers reliable moving services for homes, offices, and commercial spaces. We ensure safe handling of all items, from fragile belongings to heavy furniture. Our team plans each move carefully, providing timely updates and efficient transport solutions. Personalized moving plans guarantee security, punctuality, and convenience, making every relocation smooth and hassle-free. Trust us to manage every detail, ensuring your possessions arrive intact and on schedule.",

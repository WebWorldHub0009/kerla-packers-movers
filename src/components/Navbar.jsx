...
import logo from "../assets/kpm.png"

// Kerla Packers Color Palette
const colors = {
        ...
        <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between px-4 py-2">
          <div className="flex flex-col md:flex-row md:items-center md:gap-6 gap-1">
            <p className="flex items-center gap-2">
              ...
              <a
                href="mailto:keralapackers1@gmail.com"
            ...
            <p className="flex items-center gap-2">
             ...
             <p className="flex items-center gap-2">
              <FaPhoneAlt style={{ color: colors.primary }} />
              <a href="tel:+919555011308" className="hover:text-[#800000] transition">
               +91 9555011308
              </a>
            </p>
            <p className="flex items-center gap-2">
      ...
      >
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <Link to="/" className="flex items-center gap-2">
            <img
              src={logo} // Add your Kerla Packers logo
              alt="Kerla Packers Logo"

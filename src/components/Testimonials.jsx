...
const testimonials = [
  { name: "Ravi Kumar", title: "Client, Bangalore", text: "Kerla Packers handled my entire house relocation flawlessly. Professional, careful, and punctual service!" },
    ...
    >
      ...
      <div className="relative max-w-6xl mx-auto text-center mb-12 z-10">
        ...
        <p
          ...
          style={{ color: "#333" }}
        >
          “Trusted by thousands across Kerla for safe, on-time, and stress-free relocations.”
        </p>
      </div>

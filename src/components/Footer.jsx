    ...
    >
      ...
      <div className="relative z-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-12 text-white">
        ...
        <div>
          ...
          <div className="mt-4">
            <a
              href="mailto:info@keralapackers.in"
        ...
        <div>
          ...
          <div className="mt-6">
            ...
            <a href="mailto:info@keralapackers.in" className="block hover:text-[#B91C1C]">
              info@keralapackers.in
            </a>
            <a href="mailto:keralapackers1@gmail.com" className="block mt-1 hover:text-[#B91C1C]">
             keralapackers1@gmail.com
            </a>
      ...
      <div className="mt-5 text-center border-t border-white/10 pt-6 text-sm relative z-10 text-gray-200 space-y-2">
        <VisitorCounter />
        <p>© {new Date().getFullYear()} Kerla Packers. All Rights Reserved.</p>
        <p>
          Designed by{" "}
          <a

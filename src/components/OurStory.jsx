  ...
  const stats = [
    {
      ...
      desc: "Providing reliable logistics and packing services across Kerla.",
    },
    {
      value: "500+",
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        ...
        <div className="flex flex-col justify-start space-y-5">
          ...
          <p className="text-[#1D4ED8] max-w-lg font-medium" style={{ fontFamily: "'Orbitron', sans-serif" }}>
            Since 2010, Kerla Packers has been the trusted name in professional packing and relocation. We combine safety, speed, and care to deliver exceptional moving experiences.
          </p>
        ...
        <div className="flex flex-col space-y-4">
          <div className="relative rounded-xl overflow-hidden shadow-2xl hover:shadow-3xl transition-shadow duration-500">
            <img
              src={imgRight}
              alt="Kerla Packers Showcase"
              className="w-full h-full object-cover"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-black/20 to-transparent" />
          </div>
          <p className="text-sm italic text-[#1D4ED8] max-w-md font-medium" style={{ fontFamily: "'Zen Dots', cursive" }}>
            Ensuring each move is safe, reliable, and professional — Kerla Packers redefines relocation experiences.
          </p>
        </div>
      </div>

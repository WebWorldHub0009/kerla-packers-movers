    ...
    >
      ...
      >
        ...
        >
          ...
          <br />
          Smooth with <span style={{ color: colors.white }}>Kerla Packers</span>
        </h1>

        <p
          className="text-gray-800 sm:text-lg font-bold mb-10 max-w-3xl mx-auto leading-relaxed font-[Italiana]"
        >
